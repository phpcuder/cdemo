    ...
    <div class="div-clear fl main-page">
        <div class="maps-intro div-inline fl">
            ...
            <label class="div-clear">
                ...
                <input type="text" name="" id="zip-selected" value="" placeholder="Zipcode(s)">
            </label>
            <ul class="list-check">
                <li>
        ...
        <div class="show-map div-inline fr">
            ...
            <!-- <iframe width="488" height="479" src="https://earthengine.google.org/timelapse/player?c=https%3A%2F%2Fearthengine.google.org%2Ftimelapse%2Fdata&v=-12.97805,-70.51164,9.5&r=.25&p=true" frameborder="0"></iframe> -->
        </div>
    </div>
</div>